...
{\left[
	\begin{array}{cc}
		$l_a m_a rcos{\left(\beta +\theta {\left(t\right)}\right)}-l_b m_b rcos{\left(\theta {\left(t\right)}\right)}+l_c m_c rcos{\left(\alpha +\theta {\left(t\right)}\right)} & 2m_r r^2 +2J_r +m_a r^2 +m_b r^2 +m_c r^2 \\
		J_a +J_b +J_c +2l_a^2 m_a +2l_b^2 m_b +2l_c^2 m_b  & l_a m_a rcos{\left(\beta +\theta {\left(t\right)}\right)}-l_b m_b rcos{\left(\theta {\left(t\right)}\right)}+l_c m_c rcos\left(\alpha +\theta \left(t\right)\right.$
	\end{array}
\right]}{
\left[
	\begin{array}{c}
...
{\left[
	\begin{array}{c}
		$-l_a m_a rsin{\left(\beta +\theta {\left(t\right)}\right)}{\theta^˙ }^2 +l_b m_b rsin{\left(\theta {\left(t\right)}\right)}{\theta^˙ }^2 -l_c m_c rsin{\left(\alpha +\theta {\left(t\right)}\right)}{\theta^˙ }^2 \\
		-g{\left(l_c m_c \mathrm{cos}{\left(\alpha +\theta {\left(t\right)}\right)}+l_a m_a \mathrm{sin}{\left(\beta +\theta {\left(t\right)}\right)}-l_b m_b \mathrm{sin}{\left(\theta {\left(t\right)}\right)}\ \right)}\theta^˙ -l_a m_a rsin{\left(\beta +\theta {\left(t\right)}\right)}\theta^˙ \phi^˙ +l_b m_b rsin{\left(\theta {\left(t\right)}\right)}\theta^˙ \phi^˙ -l_c m_c rsin{\left(\alpha +\theta {\left(t\right)}\right)}\theta^˙ \phi^˙ $
	\end{array}
\right]}+
{\left[
	\begin{array}{c}
